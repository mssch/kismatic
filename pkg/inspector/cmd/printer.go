...
type resultPrinter func(out io.Writer, results []inspector.RuleResult) error

func printResultsAsJSON(out io.Writer, results []inspector.RuleResult) error {
...
func printResultsAsTable(out io.Writer, results []inspector.RuleResult) error {
