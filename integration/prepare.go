...
const (
	...
	installKubeletYum         = `sudo yum -y install kubelet-1.7.3_1-1`
	installKubectlYum         = `sudo yum -y install kubectl-1.7.3_1-1`
	installKismaticOfflineYum = `sudo yum -y install kismatic-offline-1.7.3_1-1`
	...
	installKubeletApt         = `sudo apt-get -y install kubelet=1.7.3-1`
	installKubectlApt         = `sudo apt-get -y install kubectl=1.7.3-1`
	installKismaticOfflineApt = `sudo apt-get -y install kismatic-offline=1.7.3-1`
)
