...
KUBERNETES_DASHBOARD=gcr.io/google_containers/kubernetes-dashboard-arm64:v1.4.0
...
docker pull $KUBERNETES_DASHBOARD && docker save $KUBERNETES_DASHBOARD -o source/images/kubernetes-dashboard.tar
