...
| Kubernetes Node | `sudo yum -y install docker-engine-1.12.6-1.el7.centos kubelet-1.7.3_1-1 kubectl-1.7.3_1-1` |
...
| Kubernetes Node | `sudo apt-get -y -t=kismatic-xenial install docker-engine=1.12.6-0~ubuntu-xenial kubelet=1.7.3-1 kubectl=1.7.3-1` |
