...
| --- | --- | --- |
| Etcd | `sudo yum -y install kismatic-etcd-1.5.2_1-1` |
| Kubernetes Master | `sudo yum -y install kismatic-kubernetes-master-1.5.2_1-1` |
| Kubernetes Worker | `sudo yum -y install kismatic-kubernetes-node-1.5.2_1-1` |
...
| Product | Install Command |
| --- | --- | --- |
| Etcd | `sudo apt-get -y install kismatic-etcd=1.5.2-1` |
| Kubernetes Master | `sudo apt-get -y install kismatic-kubernetes-master=1.5.2-1` |
| Kubernetes Worker | `sudo apt-get -y install kismatic-kubernetes-node=1.5.2-1` |
